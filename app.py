...
<p>
Resume-Aware AI Interview Platform • AI Evaluation • Confidence Analysis • Professional Scorecard
</p>
...
with st.sidebar:
    ...
    st.caption("Professional AI Interview Platform")
